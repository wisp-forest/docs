...
7. and back to base
::: info
Do note that, unlike in this demonstration using markdown-it, Lavender does not renumber your elements and instead uses the index you provide verbatim
:::
