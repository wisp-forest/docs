...
- <Icon icon="mdi:folder-text" /> `books`
...
- <Icon icon="mdi:folder-edit" /> `entries/<book name>/`
...
- <Icon icon="mdi:folder-open" /> `categories/<book name>/`
...
- <Icon icon="mdi:folder-image" /> `structures`
...
| dynamic_book_name  | The name the *dynamic book* should display when it is set to emulate your book. This property expects a [Minecraft text object](https://minecraft.wiki/w/Raw_JSON_text_format#Appending) (which can also be just a plain string)                                                                                                                                                                                                                                             |
...
![example entry in in-game book](../assets/lavender/book-screen-annotated.png)
...
![example entry tooltip](../assets/lavender/associated-entry-tooltip.png){ .docs-image }
...
```json
{
  "title": "My First Page",
  "icon": "minecraft:quartz",
  "category": "mymod:a_category", // [!code ++]
  "associated_items": [
    "minecraft:nether_quartz_ore"
  ]
}
