...
### Flow Layout
![vertical flow layout reference](../../assets/owo/flow-layout-reference.png){ align=right width=25% style="margin: 0em 1em;" }

<Icon icon="mdi:xml" /> `<flow-layout direction="vertical|​horizontal">` <br>
<Icon icon="mdi:language-java" /> `Containers.verticalFlow(...)` | `Containers.horizontalFlow(...)`
...
### Grid Layout
<Icon icon="mdi:xml" /> `<grid-layout rows="..." columns="...">`<br>
<Icon icon="mdi:language-java" /> `Containers.grid(...)`
...
![grid layout reference](../../assets/owo/grid-layout-reference.png){ .docs-image width=60% }
