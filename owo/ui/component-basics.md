...
<Icon icon="material-symbols:square-rounded" style="color: #554994;"/> The type of the component <br>
<Icon icon="material-symbols:square-rounded" style="color: #f675a8;"/> The ID of the component (if defined) <br>
<Icon icon="material-symbols:square-rounded" style="color: #046582;"/> The absolute coordinates of the component <br>
<Icon icon="material-symbols:square-rounded" style="color: #f39189;"/> The actual size of the component <br>
<Icon icon="material-symbols:square-rounded" style="color: #90c8ac;"/> The margins of the component: `<top,bottom,left,right>` <br>
<Icon icon="material-symbols:square-rounded" style="color: #73a9ad;"/> The padding of the component (only on parent components)
...
![margins explainer image](../../assets/owo/margins-reference.png){ align=right width=30% style="margin: 0em 1em;" }
...
![padding explainer image](../../assets/owo/padding-reference.png){ align=right width=30% style="margin: 0em 1em;" }
...
- **Content** | <Icon icon="mdi:xml" /> `method="content"` <Icon icon="mdi:language-java" /> `Sizing.content()`
...
- **Fill** | <Icon icon="mdi:xml" /> `method="fill"` <Icon icon="mdi:language-java" /> `Sizing.fill(...)`
...
- **Fixed** | <Icon icon="mdi:xml" /> `method="fixed"` <Icon icon="mdi:language-java" /> `Sizing.fixed(...)`
...
- **Layout** | <Icon icon="mdi:xml" /> `type="layout"` <Icon icon="mdi:language-java" /> `Positioning.layout()`
...
- **Relative** | <Icon icon="mdi:xml" /> `type="relative"` <Icon icon="mdi:language-java" /> `Positioning.relative(...)`
...
- **Absolute** | <Icon icon="mdi:xml" /> `type="absolute"` <Icon icon="mdi:language-java" /> `Positioning.absolute(...)`
