...
::: warning
In order to enable nested translations you must include `"owo:nested_lang": true` in your language file.
:::
...
2. If you weren't paying attention before, `"owo:nested_lang": true` is required anywhere in your language file in order to enable nested Translations.
