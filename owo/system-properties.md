...
#### <Icon icon="material-symbols:toggle-on-outline" /> `-Dowo.handshake.disable <true|false>`
...
#### <Icon icon="material-symbols:toggle-on-outline" /> `-Dowo.debug <true|false>`
...
#### <Icon icon="material-symbols:toggle-on-outline" /> `-Dowo.forceDisableDebug <true|false>`
...
#### <Icon icon="material-symbols:toggle-on-outline" /> `-Dowo.sentinel.forceHeadless <true|false>`
