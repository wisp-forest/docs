...
### Buy Item
<Icon icon="mdi:identifier" /> `numismatic-overhaul:buy_stack`
...
### Sell Item
<Icon icon="mdi:identifier" /> `numismatic-overhaul:sell_stack`
...
### Process Item
<Icon icon="mdi:identifier" /> `numismatic-overhaul:process_item`
...
### Sell Map
<Icon icon="mdi:identifier" /> `numismatic-overhaul:sell_map`
...
<Icon icon="mdi:identifier" /> `numismatic-overhaul:dimension_sell_stack`
...
<Icon icon="mdi:identifier" /> `numismatic-overhaul:sell_single_enchantment`
...
### Sell Enchanted Item
<Icon icon="mdi:identifier" /> `numismatic-overhaul:enchant_item`
...
### Sell Dyed Armor
<Icon icon="mdi:identifier" /> `numismatic-overhaul:sell_dyed_armor`
...
<Icon icon="mdi:identifier" /> `numismatic-overhaul:sell_potion_container`
